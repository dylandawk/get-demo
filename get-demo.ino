...
const char serverAddress[] = "157.230.182.5";  // server address
int port = 3000;  // for https. will change later after PM setup
...
int pixelArray[NUM_ROWS][NUM_COLS];
int topRow = NUM_COLS - 3;
int leftCol = NUM_COLS - 2;
int bottomRow = NUM_ROWS - 2 + NUM_COLS - 2;
int rightCol = ((NUM_ROWS - 2 + NUM_COLS - 2) * 2) - 1;
int currCol = 0;
